 ...
 * </p>
 * <p>
 *    子类必须实现抽象的{@link #findCandidateAdvisors()}方法，以返回应用于任何对象的Advisor列表。 子类还可以覆盖继承的{@link #shouldSkip}方法，以从自动代理中排除某些对象。
 * </p>
 * <p>
 *    基于顺序的Advisors or advices应实现{@link org.springframework.core.Ordered}接口。 对Advisors进行排序。 未实现Ordered接口的Advisor将被视为无序; 它们将以未定义的顺序出现在Advisor的末尾
 * </p>
 *
 * @author Rod Johnson
...
public abstract class AbstractAdvisorAutoProxyCreator extends AbstractAutoProxyCreator {
	 ...
	 *
	 * <p>
	 *     搜索给定的候选Advisors，找到可以应用于指定bean的所有Advisors。
	 * </p>
