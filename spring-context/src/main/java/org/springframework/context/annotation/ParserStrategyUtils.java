 ...
 *
 * <p>
 *     用于处理解析器策略的公共委托代码，例如， TypeFilter，ImportSelector，ImportBeanDefinitionRegistrar
 * </p>
 *
...
abstract class ParserStrategyUtils {
	 ...
	 * <p>
	 *     如果由给定对象实现，则调用BeanClassLoaderAware，BeanFactoryAware，EnvironmentAware和ResourceLoaderAware契约。
	 * </p>
	 */
