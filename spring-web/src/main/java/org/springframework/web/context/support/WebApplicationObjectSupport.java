 ...
 *
 * <p>
 *     WebApplicationContext中运行的应用程序对象的便捷超类。 提供{@code getWebApplicationContext()}， {@code getServletContext()}和{@code getTempDir()}访问器。
 * </p>
 * <p>
 * 注意：通常建议对所需的实际回调使用单独的回调接口。 这个广泛的基类主要用于框架内，如果需要ServletContext访问等。
 * </p>
 *
